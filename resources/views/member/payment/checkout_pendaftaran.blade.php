					...
					<div align="center"><img src="{{ asset('assets/logo/bni.jpg') }}" width="100px"></div>
						<table class="table">
							...
							<tr>
								<td>Jumlah
									<br>
								<b>Rp{{number_format(($biaya->harga+$biaya->administrasi+(($biaya->harga+$biaya->administrasi)*($biaya->ppn/100))))}}</b></td>
							</tr>
						</table>
						<hr>
						<form action="{{route('member.pembayaran.upload.pendaftaran')}}" method="POST" enctype="multipart/form-data">
							@csrf
